  ...
  return (
    <div style={{ padding:'24px 28px', maxWidth:800 }}>
      ...
      <PageHeader
        ...
        subtitle="Submit a diplomatic clearance application from a Foreign Mission"
      />
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Card style={{ marginBottom:28 }}>
          ...
          <div style={{ display:'flex', gap:12, marginBottom: form.clearance_type === 'EMERGENCY' ? 14 : 0 }}>
            {[['STANDARD','Standard (10 working days)'],['EMERGENCY','⚡ Emergency (24 hours)']].map(([v,l]) => (
              <label key={v} style={{
          ...
          {form.clearance_type === 'EMERGENCY' && (
            <label style={{ display:'flex', flexDirection:'column', gap:4 }}>
              ...
              <textarea
                ...
                required
                placeholder="Provide justification for emergency processing..."
                rows={2}
                style={{
        ...
        <div style={{ display:'flex', gap:12 }}>
          ...
          <Button variant="primary" type="submit" disabled={mutation.isPending}
            ...
            {mutation.isPending ? '⏳ Submitting…' : '→ Submit Clearance Request'}
          </Button>
        </div>
      </form>
    </div>

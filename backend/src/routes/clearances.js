...
router.post('/', [
  ...
  try {
    const { request_id, issued_by_officer, conditions } = req.body;
    ...
    const result = await db.transaction(async (client) => {
      ...
      if (request.status !== 'ALL_APPROVED') {
        throw Object.assign(
      ...
      const { rows: [clearance] } = await client.query(`
        INSERT INTO final_clearances
          (request_id, issued_by_dept_id, clearance_number, digital_hash, qr_payload,
           valid_from, valid_until, conditions, issued_by_officer)
        VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)
        RETURNING *
      `, [
        request_id, dfa.dept_id, clearanceNumber, digitalHash, qrPayload,
        request.proposed_entry_date, request.proposed_exit_date,
